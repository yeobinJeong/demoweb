 ...
 * Generated at: 2016-04-22 05:52:16 UTC
...
import com.demoweb.servlet.DotDisplay;
...
public final class display_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.demoweb.servlet.DotDisplay");
  }
...
return;
 ...
 String[] afterColor = (String[])request.getAttribute("aftercolor");
      ...
      out.write("\tvar afterindex=[];\r\n");
      out.write("\tvar aftercolor=[];\r\n");
      out.write("\t\r\n");
      out.write("\tvar count=0;\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\tfunction dotMove(targetindex, targetcolor){\r\n");
      out.write("\t\t\tdotClean();\r\n");
      out.write("\t\r\n");
      out.write("\t\t\tif(count < 10 ){\r\n");
      out.write("\t\t\t\tmoveLeft(targetindex);\r\n");
      out.write("\t\t\t\tcount++;\t\t\t\t\r\n");
      out.write("\t\t\t}else if(9 < count && count < 25 ){\r\n");
      out.write("\t\t\t\tmoveRight(targetindex);\r\n");
      out.write("\t\t\t\tcount++;\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tcount=0;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t dotDisplay(targetindex ,targetcolor); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t movetimer = setTimeout(function(){\r\n");
      out.write("\t\t\t\tdotMove(targetindex , targetcolor)\r\n");
      out.write("\t\t\t}, 500);  \r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\tfor(var k=0; k< targetindex.length; k++){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tvar kx = parseInt(targetindex[k]%40);\r\n");
      out.write("\t\t\t\t\tvar ky = parseInt(targetindex[k]/40);\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif(kx <10){\r\n");
      out.write("\t\t\t\t\t\tfor(var a=0; a<10; a++){\r\n");
      out.write("\t\t\t\t\t\t\tif((10-kx) == a ){\r\n");
      out.write("\t\t\t\t\t\t\t\ttargetindex[k] = ky*40+(10+a);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}else if (kx == 10){\r\n");
      out.write("\t\t\t\t\t\ttargetindex[k] = ky*40+(10);\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\tfor(var a=0; a<10; a++){\r\n");
      out.write("\t\t\t\t\t\t\tif((kx-10)==a)\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\ttargetindex[k] = ky*40+(10-a);\t\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      ...
      out.write("\tvar evoltimer=null;\r\n");
      out.write("\tfunction evol(event){\r\n");
      out.write("\t\tdoStop(movetimer);\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\tevoltimer = setTimeout(\"evol()\", 100);\r\n");
      out.write("\t\tif(count == 10){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tdoStop(evoltimer);\r\n");
      out.write("\t\t\tcount =0;\r\n");
      out.write("\t\t\tevolCnt=0;\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tdotClean();\r\n");
      out.write("\t\t\tboomb(boomindex, boomcolor);\r\n");
      out.write("\t\t}else if(count > 10){ count=0;}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\tvar boomCnt=0;\r\n");
      out.write("\tvar boombtimer = null\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tboombtimer = setTimeout(\"boomb()\", 100);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(count == 10){\r\n");
      out.write("\t\t\t\tdoStop(boombtimer);\r\n");
      out.write("\t\t\t\tcount =0;\r\n");
      out.write("\t\t\t\tboomCnt=0;\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tdotClean();\r\n");
      out.write("\t\t\t\tdotDisplay(afterindex, aftercolor);\r\n");
      out.write("\t\t\t\tdotMove(afterindex, aftercolor);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
 ...
 for(int i=0; i<afterData.length; i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tafterindex[");
      out.print(i);
      out.write("] = ");
      out.print(temp2);
      out.write(";\r\n");
      out.write("\t\t\taftercolor[");
      out.print(i);
      out.write("] = \"");
      out.print(afterColor[i]);
      out.write("\";\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tdotDisplay(varindex, varcolor);\r\n");
      out.write("\t\t\tdotMove(varindex, varcolor);\r\n");
      out.write("\t\t\t/* dotDisplay(varindex, varcolor); \r\n");
      out.write("\t\t\ttimer =  window.setTimeout(\"dotMove()\", 500);  */\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction doStop(timeout){\r\n");
