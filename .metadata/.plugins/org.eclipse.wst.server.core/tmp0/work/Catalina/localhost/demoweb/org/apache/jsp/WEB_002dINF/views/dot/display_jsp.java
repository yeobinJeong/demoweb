 ...
 * Generated at: 2016-04-19 09:37:22 UTC
...
return;
 ...
 for(int i=0; i<dotData.length; i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\t\tcount += 1;\r\n");
      out.write("\t\t\t} else if (count < 5){\r\n");
      out.write("\t\t\t\t// 처음이 아닌경우 이전 픽셀 값에서 -2 하는 구문\r\n");
      out.write("\t\t\t\t");
 for(int i=0; i<dotData.length; i++) {
      out.write("\r\n");
      out.write("\t\t\t\t\tvarindex[");
 ...
 for(int i=0; i<dotData.length; i++) {
      out.write("\r\n");
      out.write("\t\t\t\tvar index = varindex[");
      out.print(i);
      out.write("];\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tdot[index].style.backgroundColor = \"");
